...
INSERT ALL
  ...
  INTO reply (cidx, vidx, cid, ccontent, cdate, crecommend, cnotrecommend, cref, clev, csunbun)
  VALUES (10, 2, 'user001', '저도 여기가 제일 좋았어요! 정말 추천합니다.', TO_DATE('2025-02-20 11:00:00', 'YYYY-MM-DD HH24:MI:SS'), 6, 0, 1, 1, 1)

  -- 대댓글 2 (댓글 2번에 대한 답글, 작성 3일 후 오후)
  INTO reply (cidx, vidx, cid, ccontent, cdate, crecommend, cnotrecommend, cref, clev, csunbun)
  VALUES (11, 2, 'user002', '가격이 괜찮은 곳이죠? 계속 가고 싶어요.', TO_DATE('2025-02-21 16:30:00', 'YYYY-MM-DD HH24:MI:SS'), 4, 0, 2, 1, 1)

  -- 대대댓글 1 (대댓글 1번에 대한 답글, 작성 1일 후 오후)
  INTO reply (cidx, vidx, cid, ccontent, cdate, crecommend, cnotrecommend, cref, clev, csunbun)
  VALUES (12, 2, 'user003', '저도 여기가 너무 좋아서 추천드립니다!', TO_DATE('2025-02-22 15:30:00', 'YYYY-MM-DD HH24:MI:SS'), 7, 0, 1, 2, 2)
