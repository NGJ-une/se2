...
<%@include file = "h1_header.jsp" %>
    <section class="section1">
        <article>
            <div class="slider">
                <img src="" alt="h1" class="slide">
                <img src="/se2/hotel_1/review/img/2.jpg" alt="h2" class="slide">
                <img src="/se2/hotel_1/review/img/3.jpg" alt="h3" class="slide">
                <img src="/se2/hotel_1/review/img/1.jpg" alt="h4" class="slide">
