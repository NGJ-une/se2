...
<link rel="stylesheet" type="text/css"
	href="/se2/hotel_Seoul/css/main.body_page.css">
		...
		<article>
			<div class="slider">
				<div class="slide active">
					<img src="/se2/gallery/img/seoul/other/LocalArea.png" alt="h1">
				...
				<div class="slide">
					<img src="/se2/gallery/img/seoul/other/hotel_Lobby.png" alt="h2">
					<div class="slide-caption fixed-bottom-left">
				...
				<div class="slide">
					<img src="/se2/gallery/img/seoul/other/hotel_Desk.png" alt="h3">
					<div class="slide-caption fixed-bottom-left">
				...
				<div class="slide">
					<img src="/se2/gallery/img/seoul/dining/S_bar3.png" alt="h4">
					<div class="slide-caption fixed-bottom-left">
				...
				<div class="slide">
					<img src="/se2/gallery/img/seoul/room/S_G.jpg" alt="h5">
					<div class="slide-caption fixed-bottom-left">
				...
				<div class="slide">
					<img src="/se2/gallery/img/seoul/room/S_S5.jpg" alt="h8">
					<div class="slide-caption fixed-bottom-left">
				...
				<div class="slide">
					<img src="/se2/gallery/img/seoul/dining/S_bar1.png" alt="h9">
					<div class="slide-caption fixed-bottom-left">
