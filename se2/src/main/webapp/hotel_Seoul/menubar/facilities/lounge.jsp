	...
	<div class="container">
		...
		<section class="box1">
			...
			<ul>
				...
				<li><a href="/se2/hotel_Seoul/menubar/facilities/lounge.jsp"><strong>연회장</strong></a></li>
		...
		<div class="room-content">
			<div class="room-content-inner">
				<h2 class="room-title">연회장</h2>

				<div class="room-visual-wrap">
					<div class="room-main-image">
						<img src="/se2/gallery/img/seoul/facilities/S_Grand_Room.png" alt="라운지 이미지">
					</div>
