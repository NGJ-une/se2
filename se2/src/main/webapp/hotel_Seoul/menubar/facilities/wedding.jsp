	...
	<div class="container">
		...
		<section class="box1">
			...
			<ul>
				...
				<li><a href="/se2/hotel_Seoul/menubar/facilities/wedding.jsp"><strong>리딩룸</strong></a></li>
		...
		<div class="room-content">
			<div class="room-content-inner">
				<h2 class="room-title">클래식 리딩룸 라운지</h2>

				<div class="room-visual-wrap">
					<div class="room-main-image">
						<img src="/se2/gallery/img/seoul/facilities/S_Lounge.png" alt="리딩룸 이미지">
					</div>
					<div class="room-side-info">
					<br>
						<ul>
							<li><strong>위치</strong>&ensp;헬라서울 3층</li>
				...
				<p class="room-description">
					...
					<br>체크아웃 이후에도 편안하게 이용 가능한, <span
						class="desc-strong">헬리아</span> 서울의 대표적인 공간입니다.
