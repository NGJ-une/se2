...
<link rel="stylesheet" type="text/css"
	href="/se2/main/hotelConfirm/css/nlc.css">
</head>
<body>
	...
	<section class="confirmNLC">
		<article>
			<div class="confirm-box wrapper">
				<form name="ConfirmNumberCheck" action="hotelConfirmNLC_ok.jsp"
					method="post">
					<h2>예약번호로 예약내역 확인</h2>
					...
					<ul class="info-list">
						...
						<li><a href="/se2/main/member/login.jsp">로그인</a>하시면 더 빠른 조회가
							가능합니다.</li>
					</ul>
					...
					<fieldset>
						...
						<div class="form-row">
							<label for="confirmNumber">예약번호</label> <input type="number"
								name="confirmNumber" id="confirmNumber" required>
						</div>
						...
						<div class="form-buttons">
							<input type="reset" value="비우기"> <input type="submit"
								value="예약 확인">
						</div>
					</fieldset>
				</form>
