...
<div class="container">
    ...
    <section class="box2">
      <h1 style="color: #6b4c2f;"> HELIA Seoul </h1>
          ...
          <tr>
       	  ...
       	  <tr>
       	  	  <td class="td2">
       	  	  	...
       	  	  	한국의 전통미와 현대적 감각을 겸비하고 있는 세계 속의 명문호 서울 HELIA호텔은 세계 최고의 어번(Urban)의 라이프 스타일 호텔로 고객들에게 최고급 Hospitality 서비스를 제공합니다.
       	  ...
       	  <tr>
       	  	  <td>
       	  	  	...
       	  	  	LHW의 멤버로 세계 럭셔리 호텔들과 어깨를 나란히 하고 있는 서울 헬리아호텔은
      ...
      <br>
      <p>HELIA호텔은 전 세계 고객의 다양한 기대를 충족시키기 위해, 세심한 배려와 고품격 시설을 갖춘 글로벌 스탠다드의 호텔입니다. 비즈니스, 문화, 휴식의 모든 순간이 특별해질 수 있도록 최고의 경험을 선사합니다.

		핵심 가치: The Pride of HELIA </p>
      <ul>
