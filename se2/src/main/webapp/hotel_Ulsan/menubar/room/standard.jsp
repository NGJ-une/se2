...
<body>
	...
	<div class="container">
		...
		<section class="box1">
			...
			<hr>
			<ul>
				<li><a href="/se2/hotel_Ulsan/menubar/room/standard.jsp"><strong>스탠다드</strong></a></li>
				...
				<li><a href="/se2/hotel_Ulsan/menubar/room/view_All.jsp">전체객실보기</a></li>
			</ul>
		</section>
		...
		<div class="room-content">
			<div class="room-content-inner">
				<h2 class="room-title">스탠다드</h2>

				<div class="room-visual-wrap">
					<div class="room-main-image">
						<img src="/se2/gallery/img/ulsan/room/U_ST2.jpg" alt="스탠다드 룸 이미지">
					</div>
				...
				<p class="room-description">
					<span class="desc-title">3~16층에 위치한 스탠다드룸은</span><br> <span
						class="desc-strong">편안함과 쾌적함이 인상적인 최상의 휴식 환경</span>을 제공합니다.<br>
				...
				<div class="room-info-table">
					<p>
						<strong>위치</strong>: 3 ~ 16층<br> <strong>전망</strong>: 시티 뷰<br>
