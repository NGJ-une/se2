	...
	<div class="container">
		...
		<section class="box1">
			...
			<ul>
				...
				<li><a href="/se2/hotel_Ulsan/menubar/room/grand.jsp"><strong>그랜드</strong></a></li>
		...
		<div class="room-content">
			<div class="room-content-inner">
				<h2 class="room-title">그랜드</h2>

				<div class="room-visual-wrap">
					<div class="room-main-image">
						<img src="/se2/gallery/img/ulsan/room/U_G.jpg" alt="그랜드 룸 이미지">
					</div>
				...
				<p class="room-description">
					<span class="desc-title">23~26층에 위치한 그랜드룸은</span><br> <span
						class="desc-strong">모던한 디자인이 돋보이는 넓은 공간</span>을 자랑합니다.<br>
				...
				<div class="room-info-table">
					<p>
						<strong>위치</strong>: 23 ~ 26층<br> <strong>전망</strong>: 시티 뷰<br>
