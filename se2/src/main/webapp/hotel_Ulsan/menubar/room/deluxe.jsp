	...
	<div class="container">
		...
		<section class="box1">
			...
			<ul>
				...
				<li><a href="/se2/hotel_Ulsan/menubar/room/deluxe.jsp"><strong>디럭스</strong></a></li>
			...
			<div class="room-content-inner">
				...
				<div class="room-visual-wrap">
					<div class="room-main-image">
						<img src="/se2/gallery/img/ulsan/room/U_D2.jpg" alt="디럭스 룸 이미지">
					</div>
				...
				<p class="room-description">
					<span class="desc-title">17~26층에 위치한 그랜드룸은</span><br> <span
						class="desc-strong">도심에서의 여유로운 휴식을 누릴 수 있는 최상의 선택</span>입니다.<br>
				...
				<div class="room-info-table">
					<p>
						<strong>위치</strong>: 17 ~ 26층<br> <strong>전망</strong>: 시티 뷰<br>
